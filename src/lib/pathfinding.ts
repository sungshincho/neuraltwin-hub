...
const PATH_CASES: [number, number, number][][] = [
  ...
  [
    ...
    [-4, 0.5, -1], [-5, 0.5, -1], [-5, 0.5, -2], [-6, 0.5, -2],
  ],
  // Case 2 (69 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
    ...
    [-6, 0.5, 5], [-7, 0.5, 5], [-7, 0.5, 4], [-7, 0.5, 3], [-7, 0.5, 2], [-7, 0.5, 1],
    [-7, 0.5, 0], [-6, 0.5, 0], [-5, 0.5, 0], [-4, 0.5, 0], [-3, 0.5, 0], [-3, 0.5, -1],
    [-4, 0.5, -1], [-5, 0.5, -1], [-5, 0.5, -2], [-6, 0.5, -2], [-6, 0.5, -1], [-6, 0.5, 0],
    [-5, 0.5, 0], [-4, 0.5, 0], [-3, 0.5, 0], [-2, 0.5, 0], [-2, 0.5, 1], [-2, 0.5, 2],
    [-2, 0.5, 3],
  ],
  // Case 3 (56 포인트)
  [
    ...
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4], [-5, 0.5, 5],
    [-6, 0.5, 5], [-7, 0.5, 5], [-7, 0.5, 4], [-7, 0.5, 3], [-7, 0.5, 2], [-7, 0.5, 1],
    [-7, 0.5, 0], [-6, 0.5, 0], [-5, 0.5, 0], [-4, 0.5, 0], [-3, 0.5, 0], [-2, 0.5, 0],
  ],
  // Case 4 (68 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
    ...
    [1, 0.5, 4], [0, 0.5, 4], [-1, 0.5, 4], [-1, 0.5, 3],
  ],
  // Case 5 (49 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
    ...
    [-5, 0.5, -2], [-6, 0.5, -2], [-6, 0.5, -1], [-6, 0.5, 0], [-7, 0.5, 0], [-7, 0.5, 1],
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4], [-5, 0.5, 5],
    [-4, 0.5, 5], [-3, 0.5, 5], [-2, 0.5, 5], [-1, 0.5, 5], [0, 0.5, 5],
  ],
  // Case 6 (51 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
    ...
    [-5, 0.5, -2], [-6, 0.5, -2], [-6, 0.5, -1], [-6, 0.5, 0], [-7, 0.5, 0], [-7, 0.5, 1],
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4], [-5, 0.5, 5],
    [-4, 0.5, 5], [-3, 0.5, 5], [-2, 0.5, 5], [-1, 0.5, 5], [0, 0.5, 5], [0, 0.5, 4],
    [0, 0.5, 3],
  ],
  // Case 7 (61 포인트)
  [
    ...
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4], [-5, 0.5, 5],
    [-4, 0.5, 5], [-3, 0.5, 5], [-2, 0.5, 5], [-1, 0.5, 5], [0, 0.5, 5], [0, 0.5, 4],
    [0, 0.5, 3], [0, 0.5, 2], [0, 0.5, 1], [1, 0.5, 1], [2, 0.5, 1], [3, 0.5, 1],
    [3, 0.5, 2], [3, 0.5, 3], [3, 0.5, 4],
  ],
  // Case 8 (48 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
  ...
  [
    ...
    [-4, 0.5, 5], [-3, 0.5, 5], [-2, 0.5, 5], [-1, 0.5, 5], [0, 0.5, 5], [0, 0.5, 4],
    [0, 0.5, 3], [0, 0.5, 2], [0, 0.5, 1], [1, 0.5, 1], [2, 0.5, 1], [3, 0.5, 1],
    [3, 0.5, 2], [3, 0.5, 3], [3, 0.5, 4], [2, 0.5, 4], [2, 0.5, 5], [3, 0.5, 5],
    [4, 0.5, 5], [5, 0.5, 5],
  ],
  // Case 10 (53 포인트)
  [
    ...
    [-5, 0.5, -2], [-6, 0.5, -2], [-6, 0.5, -1], [-6, 0.5, 0], [-7, 0.5, 0], [-7, 0.5, 1],
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4], [-5, 0.5, 5],
    [-4, 0.5, 5], [-3, 0.5, 5], [-2, 0.5, 5], [-1, 0.5, 5], [0, 0.5, 5], [1, 0.5, 5],
    [2, 0.5, 5], [3, 0.5, 5], [4, 0.5, 5],
  ],
  // Case 11 (49 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
  ...
  [
    ...
    [0, 0.5, 3], [0, 0.5, 2], [0, 0.5, 1], [1, 0.5, 1], [2, 0.5, 1], [3, 0.5, 1],
    [3, 0.5, 2], [3, 0.5, 3], [3, 0.5, 4], [2, 0.5, 4], [2, 0.5, 5], [3, 0.5, 5],
    [4, 0.5, 5], [5, 0.5, 5], [5, 0.5, 4], [5, 0.5, 3], [5, 0.5, 2],
  ],
  // Case 14 (48 포인트)
  [
    [2, 0.5, 5], [2, 0.5, 4], [3, 0.5, 4], [3, 0.5, 3], [3, 0.5, 2], [3, 0.5, 1],
  ...
  [
    ...
    [-6, 0.5, 3], [-6, 0.5, 2], [-6, 0.5, 1], [-6, 0.5, 0], [-5, 0.5, 0], [-5, 0.5, -1],
    [-5, 0.5, -2], [-6, 0.5, -2], [-6, 0.5, -1], [-6, 0.5, 0], [-7, 0.5, 0], [-7, 0.5, 1],
    [-7, 0.5, 2], [-7, 0.5, 3], [-6, 0.5, 3], [-6, 0.5, 4], [-5, 0.5, 4],
  ],
];
