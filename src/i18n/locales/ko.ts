export default {
  ...
  contact: {
    ...
    consent: {
      ...
      privacyDoc: {
        purpose: "수집 목적",
        purpose1: "문의 접수 및 상담 답변 제공",
        purpose2: "서비스 도입 관련 안내",
        items: "수집 항목",
        items1: "필수: 이름, 회사명, 이메일, 문의 내용",
        items2: "선택: 연락처, 매장 수, 관심 기능, 희망 도입 시기",
        period: "보유 기간",
        periodDesc: "문의 처리 완료 후 3년간 보관 (관련 법령에 따름)",
        rights: "거부 권리",
        rightsDesc: "동의를 거부할 권리가 있으나, 필수 항목 미동의 시 문의 접수가 불가합니다.",
      },
      marketingTitle: "소식 및 혜택 정보 수신 동의",
      marketingDoc: {
        intro: "NEURALTWIN의 신규 기능, 업데이트 소식, 프로모션 및 이벤트 혜택 정보를 이메일로 받아보실 수 있습니다.",
        info: "수신 정보",
        info1: "신규 기능 및 업데이트 안내",
        info2: "할인 프로모션 및 이벤트 정보",
        info3: "리테일 인사이트 및 활용 팁",
        withdraw: "수신 철회",
        withdrawDesc: "수신 동의 후에도 이메일 하단의 '수신거부' 링크를 통해 언제든지 철회할 수 있습니다.",
      },
    },
  },
  auth: {
